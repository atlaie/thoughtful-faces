...
dats_train = np.load('Predictors_emissions_mouse_concat_train_10pad.npz', allow_pickle = True)
...
for num_state in internal_states:
    ...
    if __name__ == '__main__':
        ...
        np.save('ARHMM_CVscores_mouse_'+str(num_state)+'06112023.npy', scores_cv[num_state - internal_states[0], :])